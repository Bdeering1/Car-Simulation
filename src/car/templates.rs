...
impl Templates for Car {
    fn from_template(template: CarType) -> Self {
        match template {
            ...
            // https://www.carsguide.com.au/audi/r8/car-dimensions/2018
            CarType::AudiR8 => {
                ...
                let chassis = Chassis::new(0.254, 2.64922, 1.23, 0.44, 1587.12, 30.0, DriveWheels::Front);
            ...
            CarType::TeslaSPlaid => {
                ...
                let chassis = Chassis::new(0.2667, 2.9591, 1.40, 0.48, 2184.501, 30.0, DriveWheels::All);
