...
impl Car {
    ...
    pub fn update(&mut self, dt: f64) {
        ...
        if self.engine.rpm == self.engine.max_rpm {
            ...
            self.drive_force = self.chassis.get_wheel_force(self.drive_force, self.engine.get_torque(0.01) * self.transmission.get_ratio(), self.velocity, dt).0;
        }
        ...
        let drive_wheel_rpm: f64 = match self.chassis.drive_wheels {
            ...
            DriveWheels::All => self.chassis.front_wheels.ang_vel * 9.549296585513721, //TODO: avg velocity between both sets of wheels
        };
